...
namespace ReceiveCardAIO
{
    ...
    public static class PrinterHelper
    {
        ...
        /// <returns></returns>
        [DllImport(Dll_PATH, EntryPoint = "TxOpenPrinter")]
        public static extern bool TxOpenPrinter(int type, int idx);
        /// <summary>
        /// 关闭打印机连接
        /// </summary>
        /// <returns></returns>
        [DllImport(Dll_PATH, EntryPoint = "TxClosePrinter")]
        ...
        /// </returns>
        [DllImport(Dll_PATH, EntryPoint = "TxGetStatus")]
        ...
        /// </param>
        /// <param name="str"></param>
        [DllImport(Dll_PATH, EntryPoint = "TxPrintBarcode")]
         ...
         * @return 操作是否成功
         */
        [DllImport(Dll_PATH, EntryPoint = "TxWritePrinter")]
         ...
         * @return 返回实际的字节数
         */
        [DllImport(Dll_PATH, EntryPoint = "TxReadPrinter")]
        ...
        /// <returns></returns>
        [DllImport(Dll_PATH, EntryPoint = "TxDoFunction")]
